...
class gsp_handler_layoutsmain_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('layoutTitle','g',11,['default':("Handler")],-1)
})
...
invokeTag('captureBody','sitemesh',21,['ng-app':("handlerApp")],1)
printHtmlPart(5)
}
...
public static final long LAST_MODIFIED = 1440276126000L
