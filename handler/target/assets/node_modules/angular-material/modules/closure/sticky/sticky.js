var ng={};ng.material={};ng.material.components={};angular.module("material.components.sticky",["material.core","material.components.content"]).factory("$mdSticky",MdSticky);
...
200;var isScrolling;var lastScrollTime;element.on("scroll touchmove",function(){if(!isScrolling){isScrolling=true;$$rAF(loopScrollEvent);element.triggerHandler("$scrollstart")}element.triggerHandler("$scroll");lastScrollTime=+$mdUtil.now()});function loopScrollEvent(){if(+$mdUtil.now()-lastScrollTime>SCROLL_END_DELAY){isScrolling=false;element.triggerHandler("$scrollend")}else{element.triggerHandler("$scroll");$$rAF(loopScrollEvent)}}}}
MdSticky.$inject=["$document","$mdConstant","$compile","$$rAF","$mdUtil"];ng.material.components.sticky=angular.module("material.components.sticky");