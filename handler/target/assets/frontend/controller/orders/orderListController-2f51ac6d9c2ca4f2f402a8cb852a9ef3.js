angular.module('handlerApp').controller('OrderListController', ["$scope", "ngTableParams", "ProductListFactory", "FilterSearchService", function($scope, ngTableParams, ProductListFactory, FilterSearchService){
