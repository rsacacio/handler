angular.module('handlerApp').controller('ProductListController', ["$scope", "ProductListFactory", "ngTableParams", "FilterSearchService", function($scope, ProductListFactory, ngTableParams, FilterSearchService){
