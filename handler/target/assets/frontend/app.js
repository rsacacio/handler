angular.module("handlerApp", ['ngRoute', 'ngTable', 'angularSpinners', 'ui.bootstrap', 'ui.select', 'ngSanitize', 'daterangepicker'])
.config(['$routeProvider', '$httpProvider', function($routeProvider, $httpProvider) {
  $routeProvider.
	...
	when('/customers/add', {templateUrl: 'views/customers/customerAdd.html', controller: 'CustomerAddController'}).
	...
	when("/occupation/add", {templateUrl: "views/config/occupation/occupationAdd.html", controller: "OccupationAddController"}).
	when("/occupation", {templateUrl: "views/config/occupation/occupationList.html", controller: "OccupationListController"}).
